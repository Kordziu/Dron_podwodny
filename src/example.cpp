...
int main() {
  ...
  //wait4key();
   ...
   //api->draw_polygonal_chain(vector<Point3D> {
  //      drawNS::Point3D(0,0,0),
  ...
  //int b=api->draw_polygonal_chain(vector<Point3D> {
  //      drawNS::Point3D(0,0,0),
  //	drawNS::Point3D(0,-4,0),drawNS::Point3D(-4,-4,0),
  ...
  api->draw_polyhedron(vector<vector<Point3D> > {
      {
	drawNS::Point3D(0,0,0), drawNS::Point3D(2,0,0), drawNS::Point3D(2,-2,0), drawNS::Point3D(0,-2,0)
      },{
	drawNS::Point3D(0,0,1), drawNS::Point3D(2,0,1), drawNS::Point3D(2,-2,1), drawNS::Point3D(0,-2,1)       
	  }
